    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-6 col-xl-2">
          <h1 class="logo"><a href="mainClient.php">PSU Gang<span class="text-primary"></span> </a></h1>
        </div>
        ...
        <div class="col-12 col-md-10 d-none d-xl-block">
          <nav class="site-navigation position-relative text-right" role="navigation">
            ...
            <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
              ...
              <li class="has-children">
                <a href="#blog-section" class="nav-link">Servicios Adicionales</a>
                <ul class="dropdown">
                  <li><a href="">Platica con Liz</a></li>
                  <li><a href="">Calculadora de wattage</a></li>
                </ul>
              </li>
              <li class="has-children">
                <a href="#blog-section" class="nav-link">Soporte técnico</a>
                <ul class="dropdown">
                  <li><a href="" class="" id="">Ubicaciones</a></li>
                  <li><a href="" class="" id="">Condiciones de Servicios</a></li>
                </ul>
              </li>

              <li class="social"><a href="#contact-section" class="nav-link"><span class="icon-facebook"></span></a></li>
              <li class="social"><a href="#contact-section" class="nav-link"><span class="icon-instagram"></span></a></li>
              <li class="social"><a href="#contact-section" class="nav-link"><span class="icon-youtube"></span></a></li>
